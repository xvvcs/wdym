...
struct DefaultKittyRemoteControlService: KittyRemoteControlService {
  ...
  private func inspectComposerLine(_ rawLine: String, cursorColumn: Int?) -> ComposerLineInspection
  {
    ...
    -> KittenCommandResult
  {
    ...
    for candidateAddress in candidateAddresses {
      ...
      if result.exitCode == 0 {
        return KittenCommandResult(executionResult: result, resolvedListenAddress: candidateAddress)
      }
