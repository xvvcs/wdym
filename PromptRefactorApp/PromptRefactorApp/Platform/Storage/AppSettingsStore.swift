...
struct AppSettings: Equatable {
    ...
    static let `default` = AppSettings(
        ...
        groqModelRawValue: GroqModel.llama318bInstant.rawValue,
...
final class UserDefaultsAppSettingsStore: ObservableObject {
    ...
    private func persist(_ settings: AppSettings) {
        ...
        userDefaults.set(
            settings.includeClarifyingQuestions, forKey: Keys.includeClarifyingQuestions)
        ...
        userDefaults.set(
            settings.kittyRemoteControlRequired, forKey: Keys.kittyRemoteControlRequired)
        ...
        userDefaults.set(
            settings.customShortcutModifiersRawValue, forKey: Keys.customShortcutModifiers)
    }
    ...
    private static func load(from userDefaults: UserDefaults) -> AppSettings {
        ...
        let shortcutPreset =
            userDefaults.string(forKey: Keys.shortcutPreset)
            ?? AppSettings.default.shortcutPresetRawValue
